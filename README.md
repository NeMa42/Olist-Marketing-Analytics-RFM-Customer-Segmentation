...
**Data Source**: Olist E-Commerce Public Dataset (90k+ anonymized orders from 2016-2018). 
...
Segment Name | Description (Who they are) | Logic (RFM Score)
...
🌱 New Potential | Customers who just made their first purchase. They are in the "Honeymoon Phase." | R=5, F=1,

💫 Promising | Recent shoppers who haven't established a habit yet. They have potential to become Loyal. | R=3-4, F=1-2,

⚠️ Need Attention | Regular customers who are starting to drift away (Recency is dropping). They need a nudge. | R=2-3, F=3-5,

🛌 Hibernating | Former high-value customers who stopped buying long ago. There is still hope to win them back. | R=1-2, F/M=High,
...
Now let's observe specific business vulnerabilities of each group. Instead of fixing everything at once, we assigned a Strategic Priority to determine actions step by step. The top priority of the project is to stop the biggest bleeding point and to eliminate further money leackage one by one. 

1. At risk -- Churn Risk. These are proven high-value buyers who haven't visited in months. We are about to lose them, and they are the biggest group by the amount of users (22617).
2. New Customers -- Fragility. They made one purchase but haven't established loyalty. If we don't get a 2nd order in 30 days, they usually churn. They didin't spend much yet, but we need to encourage them to make another purchase. 
3. Whales -- Low Frequency. They treat Olist like a specific appliance store (one-off purchase) rather than a lifestyle marketplace. We should show more oportunities in the market.
4. Champions -- Margin Erosion. We are currently targeting them with generic discount codes, losing money on sales they would have made anyway. We need to find other marketing offers for them.
5. Loyal -- Stagnation. They are consistent but their basket size is small. They need a push to spend more.
6. Lost -- Dead Weight. Low recency, low spend. Marketing to them costs more than the revenue they generate. The least  priority group.
